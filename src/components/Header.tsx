...
export default function Header() {
  ...
  return (
    <div className="flex bg-violet-300 px-10 py-[1%] text-blue-900 gap-10 shadow-2xl border-b-2 border-b-blue-800">
      <h1 className="text-4xl font-bold pt-2 text-sky-800 tracking-wide">
      ...
      <div className="flex flex-row gap-6 pt-2">
        <div className="text-xl flex justify-end gap-2">
          <span className="text-3xl pb-3 text-center font-bold text-green-700">
            &#9990;
          </span>
